...
**Status**: 🟢 Client-Side Reordering Implemented
**Version**: v0.6.0
**Live**: [doneisbetter-rfuj3dwjs-narimato.vercel.app](https://doneisbetter-rfuj3dwjs-narimato.vercel.app)
```bash
...
- Visual reordering of cards within columns (client-side only).
